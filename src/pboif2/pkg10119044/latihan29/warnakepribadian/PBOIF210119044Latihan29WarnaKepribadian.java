 ...
 */
package pboif2.pkg10119044.latihan29.warnakepribadian;
 ...
 * warna kesukaan yang diinput oleh user
 */


public class PBOIF210119044Latihan29WarnaKepribadian {
    public static void main(String[] args) {
        ...
        System.out.println(merah+"YUK "+hijau+"CEK "+kuning+"KEPRIBADIAN "+cyan+"DARI "+ungu+"WARNA "+biru+"FAVORITMU");
        System.out.println();
        System.out.println(latarMerah+putih+"       MERAH        "+transparan);
        System.out.println(latarHijau+putih+"       HIJAU        "+transparan);
        System.out.println(latarKuning+putih+"       KUNING       "+transparan);
        System.out.println(latarBiru+putih+"       BIRU         "+transparan);
        System.out.println(latarUngu+putih+"       UNGU         "+transparan);
